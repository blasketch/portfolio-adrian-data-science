      ...
      >
        ...
        >
          ...
          <ul
            ...
            data-path="scripts/components.js"
          >
            <li data-id="gzyxpemk2" data-path="scripts/components.js">
              <a
                href="#home"
            ...
            <li data-id="avxdl31qv" data-path="scripts/components.js">
              <a
                href="#about"
                onClick={() => setIsMenuOpen(false)}
                data-id="j8j87c6h9"
            ...
            <li data-id="u7v76i31w" data-path="scripts/components.js">
              <a
                href="#skills"
                onClick={() => setIsMenuOpen(false)}
                data-id="vcb5zes8y"
            ...
            <li data-id="rhjo7geiq" data-path="scripts/components.js">
              <a
                href="#projects"
                onClick={() => setIsMenuOpen(false)}
                data-id="zzmltzplq"
            ...
            <li data-id="cz15ckwmv" data-path="scripts/components.js">
              <a
                href="#contact"
                onClick={() => setIsMenuOpen(false)}
                data-id="ume0hm6gb"
              ...
              <div className="profile-image-wrapper">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://via.placeholder.com/400x400?text=Tu+Imagen";
                  }}
                />
              </div>
            </div>
              ...
              <div className="about-image-overlay">
                <div className="about-image-caption">
                  ...
                  <span className="caption-text">
                    Arquitecturas de Deep Learning & Redes Neuronales
                  </span>
                </div>
              </div>
            </div>
...
function Skills() {
  const skillsData = [
    ...
    },
    {
      ...
      icon: "fa-cloud",
      description:
        "AWS, GCP, procesamiento distribuido, Spark, gestión de datos a escala",
      percent: 80,
    },
    {
      ...
      >
        <FadeInSection>
          ...
          <p
            ...
            data-path="scripts/components.js"
          >
            Una selección de proyectos de análisis de datos en los que he
            trabajado.
          </p>
        </FadeInSection>
          ...
          <FadeInSection delay={0.2}>
            ...
            >
              ...
              <p
                ...
                data-path="scripts/components.js"
              >
                Si estás buscando un profesional que combine experiencia técnica
                en IA con habilidades prácticas en implementación y despliegue
                de modelos, me encantaría conectar. Estoy particularmente
                interesado en roles que involucren investigación aplicada,
                desarrollo de modelos avanzados y arquitectura de sistemas de
                ML.
              </p>
              <div className="contact-buttons" data-id="contact-buttons">
                ...
                <a
                  href="mailto:newadrianblasco@gmail.com"
              ...
              >
                ...
                >
                  ...
                  <div data-id="2etyhertf" data-path="scripts/components.js">
                    ...
                    <p data-id="lsn6qnotc" data-path="scripts/components.js">
                      newadrianblasco@gmail.com
                    </p>
                  </div>
                </li>
                <li
    ...
    >
      ...
      >
        <div
          ...
          data-path="scripts/components.js"
        >
          <p data-id="71ebjt0mi" data-path="scripts/components.js">
            &copy; {new Date().getFullYear()} Adrian Blasco Lozano. Todos los
            derechos reservados.
          </p>
          <div
